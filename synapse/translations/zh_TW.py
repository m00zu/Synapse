...
STRINGS: dict[str, str] = {
    ...
    "AI Chat":              "AI 對話",
    "Node Help":            "節點說明",
    "Open Manual (Offline)": "開啟手冊（離線）",
    "Open Online Manual":   "開啟線上手冊",
    ...
    "Run Graph":                "執行圖",
    "Run":                      "執行",
    "&Run Selected (Up To)":    "&執行所選節點 (含上游)",
    "Stop execution":           "停止執行",
    "Batch Run":                "批次執行",
    "Stop":                     "停止",
    "&Auto-organize Layout":    "&自動排版",
    "Show Execution Order Badges": "顯示執行順序標籤",
    "Clear Selected":           "清除所選快取",
    "Clear caches for selected nodes": "清除所選節點的快取",
    "Clear All":                "清除全部快取",
    ...
    "Select one or more nodes to run.": "請選取一個或多個節點以執行。",
