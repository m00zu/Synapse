...
def get_plugin_dir() -> Path:
    ...
    if getattr(sys, 'frozen', False):
        # Nuitka/packaged app: prefer plugins bundled next to the executable.
        # macOS app layout: main.app/Contents/MacOS/plugins
...
class PluginManagerDialog(QtWidgets.QDialog):
    """Full plugin management UI: install, status, and uninstall."""
    ...
    def __init__(self, plugin_results: list[dict], plugin_dir: Path,
        ...
        # --- Header row: directory path + Open Folder ---
        ...
        self._restart_banner = QtWidgets.QLabel(
            "  Use Plugins \u2192 Reload Plugins to apply changes, or restart the application."
        )
        ...
        # --- Empty-state label (shown when no plugins) ---
        ...
        # --- Bottom row: Install + Close ---
        btn_row = QtWidgets.QHBoxLayout()
        install_btn = QtWidgets.QPushButton("Install Plugin...")
