...
from .custom_nodes import (
    PORT_COLORS,
    UniversalDataNode, FileReadNode, DataSummaryNode,
    DoubleVarPlotNode, DisplayNode,
    ImageReadNode, SaveNode,
    DataTableCellNode, DataFigureCellNode, ImageCellNode,
    OutlierDetectionNode, CombineTablesNode,
    GroupNormalizationNode, NormalityTestNode, SwarmPlotNode,
    GroupedComparisonNode, PairwiseComparisonNode, PairwiseMatrixNode,
    ViolinPlotNode, BoxPlotNode, BarPlotNode, ScatterPlotNode, HistogramNode, KdePlotNode,
    XYLinePlotNode, HeatmapNode, VolcanoPlotNode, RegressionPlotNode, SurvivalPlotNode,
    LinearRegressionNode, NonlinearRegressionNode, TwoWayANOVANode,
    ContingencyAnalysisNode, SurvivalAnalysisNode, PCANode,
    WhiteTopHatNode, BlackTopHatNode, BandpassFilterNode, WatershedNode, BlobDetectNode,
    FrangiNode, ColocalizationNode, GLCMTextureNode, ImageStatsNode, IntensityProfileNode,
    CannyEdgeNode, SobelEdgeNode, PrewittEdgeNode, LaplacianEdgeNode,
    FindContoursNode, HoughCirclesNode, HoughLinesNode, HoughEllipseNode,
    FolderIteratorNode, VideoIteratorNode, PathModifierNode,
    BatchAccumulatorNode,
    SplitRGBNode, MergeRGBNode, EqualizeAdapthistNode,
    GaussianBlurNode, ThresholdLocalNode, RemoveSmallObjectsNode,
    RemoveSmallHolesNode, KeepMaxIntensityRegionNode, DistanceRingMaskNode,
    ImageMathNode, ROIMaskNode, BrightnessContrastNode, BinaryThresholdNode,
    EditableTableNode, FilterTableNode, MathColumnNode, AggregateTableNode, RenameGroupNode, FigureEditNode,
    ReshapeTableNode, SortTableNode, TopNNode, ColumnValueSplitNode, TwoTableMathNode, SelectColumnsNode, GammaContrastNode,
    RGBToGrayNode, ColorDeconvolutionNode,
    CropNode, ZoomNode, ResizeNode, RotateNode, RollingBallNode, MirrorNode,
    CellEdgeMaskNode, FilopodiaDetectNode, FilopodiaAnalyzeNode,
    ErosionNode, DilationNode, MorphOpenNode, MorphCloseNode,
    FillHolesNode, SkeletonizeNode, MedialAxisNode, ParticlePropsNode, ParticleSelectNode,
    AnglePlotNode, DrawShapeNode, MaskEditorNode,
    BatchGateNode, MultiOtsuNode, RandomSampleNode,
    SkeletonAnalysisNode, SvgEditorNode,
    InteractiveParticleSelectNode, ExtractObjectNode,
)
...
def export_schema():
    # 1. Initialize a dummy QApplication so PySide widgets can instantiate without crashing
    app = QtWidgets.QApplication.instance()
    if not app:
        app = QtWidgets.QApplication(sys.argv)
    
    # 2. Create the NodeGraph and register all our nodes
    graph = NodeGraph()
