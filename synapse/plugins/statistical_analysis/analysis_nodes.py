...
class GroupedComparisonNode(BaseExecutionNode):
    ...
    def __init__(self):
        ...
        self._add_column_selector('target_column', 'Target Column', text='', mode='single')
        self._add_column_selector('group_column', 'Group Column', text='Group', mode='single')
...
class PairwiseComparisonNode(BaseExecutionNode):
    ...
    **P-Adj Method** — multiple comparison correction (Bonferroni, Holm, BH).
    ...
    def __init__(self):
        ...
        self._add_column_selector('target_column', 'Target Column', text='', mode='single')
        self._add_column_selector('group_column', 'Group Column', text='', mode='single')
...
class NormalityTestNode(BaseExecutionNode):
    ...
    def __init__(self):
        ...
        self._add_column_selector('group_column', 'Group Column (optional)', text='', mode='single')
