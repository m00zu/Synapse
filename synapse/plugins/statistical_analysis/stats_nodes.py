...
from synapse.data_models import TableData, FigureData, StatData
...
class LinearRegressionNode(BaseExecutionNode):
    ...
    def __init__(self):
        ...
        self._add_column_selector('x_cols', 'X Column(s) (comma-sep)', text='', mode='multi')
...
class TwoWayANOVANode(BaseExecutionNode):
    ...
    def __init__(self):
        ...
        self._add_column_selector('factor1',   'Factor A Column', text='', mode='single')
        self._add_column_selector('factor2',   'Factor B Column', text='', mode='single')
    ...
    def evaluate(self):
        ...
        self._refresh_column_selectors(df, 'factor1', 'factor2', 'value_col')
...
class ContingencyAnalysisNode(BaseExecutionNode):
    ...
    def __init__(self):
        ...
        self._add_column_selector('col1', 'Row Variable Column', text='', mode='single')
        self._add_column_selector('col2', 'Col Variable Column', text='', mode='single')
    ...
    def evaluate(self):
        ...
        self._refresh_column_selectors(df, 'col1', 'col2')
...
class SurvivalAnalysisNode(BaseExecutionNode):
    ...
    **P-Adj Method** — multiple comparison correction for pairwise tests.
    ...
    def __init__(self):
        ...
        self._add_column_selector('time_col',  'Time Column',                        text='', mode='single')
        self._add_column_selector('event_col', 'Event Column (1=event, 0=censored)', text='', mode='single')
        self._add_column_selector('group_col', 'Group Column (optional)',             text='', mode='single')
    ...
    def evaluate(self):
        ...
        self._refresh_column_selectors(df, 'time_col', 'event_col', 'group_col')
...
class PCANode(BaseExecutionNode):
    ...
    **Standardize** — when enabled, applies Z-score normalization before decomposition.
    ...
    def __init__(self):
        ...
        self._add_column_selector('sample_id_col', 'Sample ID Column (opt.)', text='', mode='single')
    ...
    def evaluate(self):
        ...
        self._refresh_column_selectors(df, 'sample_id_col')
