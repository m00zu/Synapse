...
import pandas as pd
import numpy as np
from synapse.nodes.base import BaseExecutionNode, PORT_COLORS, ColorPickerButtonWidget, NodeToolBoxWidget
...
class DoubleVarPlotNode(BaseExecutionNode):
    ...
    def __init__(self):
        ...
        self._add_column_selector('x_col', 'X Column')
        self._add_column_selector('y_col', 'Y Column')
        self._add_column_selector('hue', 'Hue Column (Optional)')
...
class ScatterPlotNode(BaseExecutionNode):
    ...
    def __init__(self):
        ...
        self._add_column_selector('x_col',       'X Column', text='x')
        self._add_column_selector('y_col',       'Y Column', text='y')
        self._add_column_selector('hue_col',     'Hue Column (optional)', text='')
...
class HistogramNode(BaseExecutionNode):
    ...
    def __init__(self):
        ...
        self._add_column_selector('value_col',   'Value Column',         text='value')
        self._add_column_selector('group_col',   'Group Column (opt.)',  text='')
...
class XYLinePlotNode(BaseExecutionNode):
    ...
    def __init__(self):
        ...
        self._add_column_selector('x_col',     'X Column',               text='')
        self._add_column_selector('y_col',     'Y Column',               text='')
        self._add_column_selector('group_col', 'Group Column (opt.)',    text='')
...
class HeatmapNode(BaseExecutionNode):
    ...
    def __init__(self):
        ...
        self._add_column_selector('row_label_col', 'Row Label Column (opt.)', text='')
    ...
    def evaluate(self):
        ...
        self._refresh_column_selectors(df, 'row_label_col')
...
class VolcanoPlotNode(BaseExecutionNode):
    ...
    def __init__(self):
        ...
        self._add_column_selector('fc_col',    'Log2 FC Column',           text='')
        self._add_column_selector('p_col',     'p-value Column',           text='')
        self._add_column_selector('label_col', 'Label Column (opt.)',      text='')
