...
class NodeEnum(Enum):
    ...
    SELECTED_COLOR = (100, 180, 255, 20)
    #: default node border color when selected.
    SELECTED_BORDER_COLOR = (100, 180, 255, 200)
...
class NodePropWidgetEnum(Enum):
    ...
    BUTTON = 20
    # Node property represented with a QLabel widget for image show.
    IMAGE_SHOW = 21
