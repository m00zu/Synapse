...
class _PropertiesContainer(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.__layout.setColumnMinimumWidth(0, 150)
    ...
    def add_widget(self, name, widget, value, label=None, tooltip=None):
        ...
        label_widget.setMinimumWidth(80)  # Lower minimum to let the layout breathe
        # Remove strict minimumHeight(40) so short text doesn't bloat the layout,
        # but long text can wrap downwards.
        label_widget.setSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        label_flags = QtCore.Qt.AlignmentFlag.AlignTop | QtCore.Qt.AlignmentFlag.AlignRight
...
class NodePropEditorWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, node=None):
        ...
        name_wdgt = QtWidgets.QLabel('Name')
        name_wdgt.setStyleSheet('background-color: transparent;')
        name_layout = QtWidgets.QHBoxLayout()
        name_layout.setContentsMargins(0, 0, 0, 0)
        name_layout.addWidget(name_wdgt)
